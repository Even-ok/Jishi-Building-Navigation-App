...
import com.example.supermap_demo.customs.adapters.CenterMenuAdapter;
import com.example.supermap_demo.customs.adapters.CustomDialogMenuAdapter;
import com.example.supermap_demo.customs.items.NameCardMenuItem;

public class PowerMenuUtils<onMenuItemClickListenerHi> {

  private static OnMenuItemClickListener<PowerMenuItem> onMenuItemClickListenerHi;
  ...
  public static PowerMenu getProfilePowerMenu(
    ...
    return new PowerMenu.Builder(context)
        ...
        .addItem(new PowerMenuItem("移动地图", false))
        .addItem(new PowerMenuItem("查看房间信息", false))
        .addItem(new PowerMenuItem("全屏显示", false))
            .addItem(new PowerMenuItem("距离测算", false))
        .setLifecycleOwner(lifecycleOwner)
