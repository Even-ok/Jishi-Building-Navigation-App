...
import com.example.supermap_demo.adapter.SearchItemAdapter;
import com.example.supermap_demo.bean.AreaBean;

import java.util.ArrayList;
import java.util.List;

public class SearchTabMiddle extends RelativeLayout implements ViewBaseAction{

    private ListView mListView;
    private List<AreaBean> areaList;
    private final String[]    items      = new String[] { "全部房名", "出口", "学工办", "打水区", "厕所", "娱乐区", "其他" };// 显示字段
    ...
    public SearchTabMiddle(Context context, AttributeSet attrs, int defStyle) {
