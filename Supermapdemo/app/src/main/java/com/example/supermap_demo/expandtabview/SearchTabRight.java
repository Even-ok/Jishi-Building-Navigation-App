...
import com.example.supermap_demo.adapter.SearchSysParamAdapter;
import com.example.supermap_demo.bean.SysParamsBean;
...
public class SearchTabRight extends RelativeLayout implements ViewBaseAction {
    ...
    private final String[] items = new String[] {"全部人员", "陈荣", "葛蕾", "沈莹", "朱宏明", "赵生捷", "其他"};//显示字段
